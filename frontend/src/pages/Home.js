...
const Home = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      setRecentReviews(mockReviews);
      setProducts([
        { id: 1, name: 'Sô-pha xám phong cách hiện đại', price: "25.000.000", category: 'Phòng khách', image: 'https://picsum.photos/seed/furn1/800/600', rating: 4.8 },
        { id: 2, name: 'Bàn ăn gỗ sồi nguyên khối', price: "18.500.000", category: 'Phòng ăn & Bếp', image: 'https://picsum.photos/seed/furn2/800/600', rating: 4.9 },
        { id: 3, name: 'Ghế thư giãn phong cách tối giản', price: "5.500.000", category: 'Ngoài trời', image: 'https://picsum.photos/seed/furn3/800/600', rating: 4.5 },
        { id: 4, name: 'Tủ Quần Áo Cánh Kính', price: "28.000.000", category: 'Phòng ngủ', image: 'https://picsum.photos/seed/furn4/800/600', rating: 4.7 },
        { id: 5, name: 'Bàn Trà Mặt Đá Khung Inox', price: "8.500.000", category: 'Phòng khách', image: 'https://picsum.photos/seed/furn5/800/600', rating: 4.6 },
        { id: 6, name: 'Tủ Bếp Acrylic Bóng Gương', price: "45.000.000", category: 'Phòng ăn & Bếp', image: 'https://picsum.photos/seed/furn6/800/600', rating: 4.9 },
        { id: 7, name: 'Ghế Công Thái Học Ergonomic', price: "6.800.000", category: 'Phòng làm việc', image: 'https://picsum.photos/seed/furn7/800/600', rating: 4.8 },
        { id: 8, name: 'Bàn Làm Việc Chân Sắt Chữ K', price: "1.800.000", category: 'Phòng làm việc', image: 'https://picsum.photos/seed/furn8/800/600', rating: 4.4 }
      ]);
      setLoading(false);
    };
